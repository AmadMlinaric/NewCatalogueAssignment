...
class Test implements DataPatchInterface
{
    ...
    public function execute(): void
    {
        ...
        $product
            ...
            ->setStockData(['use_config_manage_stock' => 1, 'is_qty_decimal' => 0, 'is_in_stock' => 13]);
        ...
        $this->categoryLink->assignProductToCategories($product->getSku(), [1]);
    }
